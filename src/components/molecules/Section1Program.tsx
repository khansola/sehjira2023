...
const Section1Article = () => {
    return (
        <div className='w-full grid justify-center mt-5'>
            <ul className='px-[7%]'>
                <Link className="hyperlink text-[#5D5A88]  font-semibold hover:text-blue-600 cursor-pointer" href="/">
                    Pusat Edukasi -
                </Link>
                <Link className="hyperlink text-[#5D5A88]  font-semibold hover:text-blue-600 cursor-pointer" href="/">
                    Artikel Ilmiah -
            ...
            <div className='items-left mt-2 px-[7%] font-bold  text-[#A03C78]  '>
                <h1 className='text-4xl'>Pelatihan Kemandirian Remaja Tuna Rungu Ke-5</h1>
            </div>
            <div >

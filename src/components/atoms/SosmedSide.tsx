  ...
  return (
    <>
      <div className="flex flex-col justify-center fixed mt-36 top-10 z-50">
        <Link className='hover:scale-110' href="www.facebook.com">
          <Image
        ...
        <Link className='hover:scale-110' href="www.twitter.com">
        ...
        <Link className='hover:scale-110' href="www.linkedin.com">
          <Image
        ...
        <Link className='hover:scale-110' href="www.youtube.com">
